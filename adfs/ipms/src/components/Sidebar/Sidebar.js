...
class Sidebar extends React.Component {
  ...
  createLinks = routes => {
    ...
    return routes.filter((elem=> elem.render !== false)).map((prop, key) => {
      if (prop.redirect) {
        return null;
      }
      if (prop.collapse) {
  ...
  render() {
    ...
    const logoDescription = classes.logoDescription;
    ...
    var brand = (
      <div className={logoClasses}>
        ...
        >
          {logoText} <br />
          <div className={logoDescription}>{logoDescriptionText}</div>
        </a>
      </div>
    );
    const drawerPaper =
...
Sidebar.propTypes = {
  ...
  logoDescriptionText: PropTypes.string,
